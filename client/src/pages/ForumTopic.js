          ...
          <div className="course-description">
            ...
            <Card className="new-forum">
                <form action="" method="get">
                    <div>
                        <label><h5>Forum Title: </h5></label>
                        <input type="text" className = "forum-title" id="forum-title" required></input>
                    </div>
                    <div>
                        <label><h5>Forum Description: </h5></label>
                        <input type="text" className="forum-details" id="forum-details" ></input> 
                    </div>
                    <div>
                        <label><h5>Close Forum on: </h5></label>
                        <input type="datetime-local" className="forum-date" id="forum-date" ></input> 
                    </div>
                    <div>
                         <fieldset>
                            <label><h5>Access: </h5></label>
